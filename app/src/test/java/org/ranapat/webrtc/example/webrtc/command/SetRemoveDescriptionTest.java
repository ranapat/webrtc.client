...
public class SetRemoveDescriptionTest {
    ...
    public void shouldExecuteCase1() throws JSONException {
        ...
        final SetRemoveDescription setRemoveDescription = new SetRemoveDescription();
        setRemoveDescription.execute(peer, payload, clientListener);
